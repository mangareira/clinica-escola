...
import { createAppointmentPaymentSchema, CreateAppointmentPaymentDto, appointmentPaymentParamSchema, AppointmentPaymentParamDto } from './dto/create-appointment-payment.dto';
